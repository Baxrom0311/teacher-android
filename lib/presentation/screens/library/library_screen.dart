                    ...
                    child: ListView(
                      ...
                      children: [
                        _SectionHeader(
                          ...
                          totalLabel: l10n.libraryLoanRecordsCount(
                        ...
                        _SectionHeader(
                          ...
                          totalLabel: l10n.libraryAvailableBooksCount(
...
class _LoanCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final colorScheme = Theme.of(context).colorScheme;
    final statusColor = loan.isBorrowed
    ...
    return PremiumCard(
      ...
      child: Column(
        ...
        children: [
          ...
          _DateRow(
            icon: loan.isBorrowed
                ? Icons.event_available_rounded
                : Icons.move_to_inbox_rounded,
            label:
                (loan.isBorrowed
                        ? l10n.libraryDueDateLabel('')
                        : l10n.libraryReturnedDateLabel(''))
                    .trim(),
            date: loan.isBorrowed
                ? _formatDate(loan.dueAt, l10n)
            ...
            children: [
              _InfoChip(
                ...
                color: book.availableCopies > 0
                    ? TeacherAppColors.success
                    : TeacherAppColors.error,
              ),
              if (book.category != null)
                _InfoChip(icon: Icons.category_rounded, label: book.category!),
              if (book.isbn != null)
                _InfoChip(
...
class _DateRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final colorScheme = Theme.of(context).colorScheme;
    final primaryColor = isHighlight
        ? colorScheme.primary
